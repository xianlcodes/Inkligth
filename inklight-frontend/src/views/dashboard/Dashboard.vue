...
.paper-card:nth-child(1) { animation-delay: 0.20s; }
.paper-card:nth-child(2) { animation-delay: 0.24s; }
.paper-card:nth-child(3) { animation-delay: 0.28s; }
.paper-card:nth-child(4) { animation-delay: 0.32s; }
.paper-card:nth-child(5) { animation-delay: 0.36s; }
.paper-card:nth-child(6) { animation-delay: 0.40s; }
.paper-card:nth-child(7) { animation-delay: 0.44s; }
.paper-card:nth-child(8) { animation-delay: 0.48s; }
.paper-card:nth-child(n+9) { animation-delay: 0.52s; }
...
/* Staggered entrance for month blocks */
.month-block {
  animation: monthIn 0.5s cubic-bezier(0.22, 1, 0.36, 1) both;
  animation-delay: var(--delay, 0s);
}

.mb-week {
  animation: weekIn 0.4s cubic-bezier(0.22, 1, 0.36, 1) both;
  animation-delay: var(--delay, 0s);
}
...
@media (max-width: 1024px) {
  ...
  .hero-watermark { font-size: 130px; top: -20px; right: 0; }
...
@media (max-width: 700px) {
  ...
  .hero-watermark { font-size: 80px; top: 0; right: 0; }

  .cal-months-area { flex-direction: column; gap: var(--space-3); }
  .cal-stats-strip { grid-template-columns: repeat(2, 1fr); }
  .mb-cell { height: 26px; }
  .mb-day { font-size: 10px; }
...
@media (max-width: 480px) {
  ...
  .cal-stats-strip { grid-template-columns: 1fr 1fr; }
  .cal-months-area { flex-direction: column; gap: var(--space-3); }
  .calendar-card { padding: var(--space-4); }
  .cal-legend { flex-wrap: wrap; justify-content: flex-start; }
  .mb-cell { height: 24px; }
  .mb-day { font-size: 10px; }
